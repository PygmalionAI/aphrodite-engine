...
if 89 in compute_capabilities and nvcc_cuda_version < Version("11.8"):
    # CUDA 11.8 is required to generate the code targetting compute capability 8.9,
    # however, GPUs with compute capability 8.9 can also run the code generated by
    # the previous versions of CUDA 11 and targetting compute capability 8.0,
    #so if CUDA 11.8 is not available, we target compute capability 8.0 instead.
...
if not compute_capabilities:
    compute_capabilities = {60, 65, 70, 75, 80}
