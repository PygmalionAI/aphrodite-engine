...
def test_stop_basic(aphrodite_model):
    _test_stopping(aphrodite_model.model.llm_engine,
                   ...
                   expected_output="Pygmalion is a 100% volunteer organization",
                   expected_reason=".")

    _test_stopping(aphrodite_model.model.llm_engine,
                   stop=["."],
                   include_in_output=True,
                   expected_output="Pygmalion is a 100% volunteer organization.",  # noqa: E501
                   expected_reason=".")
...
def test_stop_multi_tokens(aphrodite_model):
    _test_stopping(
        ...
        include_in_output=False,
        expected_output="Pygmalion is a 100% volunteer organization. We are a ",
    ...
    _test_stopping(
        ...
        include_in_output=True,
        expected_output=
        "Pygmalion is a 100% volunteer organization. We are a group of peo",
        expected_reason="group of peo")
...
def test_stop_partial_token(aphrodite_model):
    _test_stopping(aphrodite_model.model.llm_engine,
                   stop=["gani"],
                   include_in_output=False,
                   expected_output="Pygmalion is a 100% volunteer or",
                   expected_reason="gani")

    _test_stopping(aphrodite_model.model.llm_engine,
                   stop=["gani"],
                   include_in_output=True,
                   expected_output="Pygmalion is a 100% volunteer organi",
                   expected_reason="gani")
...
def test_stop_token_id(aphrodite_model):
    ...
    _test_stopping(aphrodite_model.model.llm_engine,
                   ...
                   include_in_output=False,
                   expected_output="Pygmalion is a 100% volunteer",
