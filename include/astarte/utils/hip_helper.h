#ifndef _ASTARTE_HIP_HELPER_H_
#define _ASTARTE_HIP_HELPER_H_
...
hipblasDatatype_t ca_to_cuda_datatype(DataType type);

miopenDataType_t ca_to_cudnn_datatype(DataType type);
