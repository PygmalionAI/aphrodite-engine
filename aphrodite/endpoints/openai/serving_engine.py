...
class OpenAIServing:
    ...
    async def tokenize_text(self, prompt: Prompt
                            ) -> Dict[str, Union[int, List[int]]]:
        """Tokenize a prompt using the model's tokenizer.
        Returns:
            value: The number of tokens in the prompt.
            ids: The token IDs of the prompt.
        """
        if self.tokenizer is None:
            raise HTTPException(status_code=500, detail="Tokenizer is not set.")
