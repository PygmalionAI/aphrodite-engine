...
class LlamaAttention(nn.Module):
    ...
    def __init__(
        ...
        self.total_num_kv_heads = self.total_num_kv_heads // tensor_model_parallel_world_size
...
class LlamaForCausalLM(nn.Module):
    ...
    def load_weights(self,
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            for (weight_name, shard_size, start_offset, end_offset) in attention_weight_specs:
