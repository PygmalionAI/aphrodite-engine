...
from aphrodite.slora.utils import make_async, LRUCache
...
def get_lora_tokenizer(lora_request: LoRARequest, *args,
    ...
    """Gets a tokenizer for the given LoRA request."""
...
class SLoRATokenizer:
    ...
    def encode(self,
        ...
        """Encodes the given prompt into a list of token IDs."""
    ...
    def get_lora_tokenizer(
        ...
        if lora_request.lora_int_id not in self.lora_tokenizer:
    ...
    async def get_lora_tokenizer_async(
        ...
        if lora_request.lora_int_id not in self.lora_tokenizers:
            tokenizer = (await get_lora_tokenizer_async(lora_request,
                                                        **self.tokenizer_config) or self.tokenizer)
            self.lora_tokenizers.put(lora_request.lora_int_id, tokenizer)
            return tokenizer
        else:
            return self.lora_tokenizers.get(lora_request.lora_int_id)
