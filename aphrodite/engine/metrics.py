...
gauge_avg_prompt_throughput = Gauge("aphrodite:avg_prompt_throughput_toks_per_s",
                                    "Average prefill throughput in tokens/s.")
gauge_avg_generation_throughput = Gauge(
    "aphrodite:avg_generation_throughput_toks_per_s",
    "Average generation throughput in tokens/s.")
counter_prompt_tokens = Counter("aphrodite:prompt_tokens_total",
                                "Number of prefill tokens processed.")
counter_generation_tokens = Counter("aphrodite:generation_tokens_total",
