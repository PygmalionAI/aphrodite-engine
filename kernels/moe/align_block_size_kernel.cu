...
void moe_align_block_size(torch::Tensor topk_ids, int64_t num_experts,
  ...
  // memory.
  // TODO: the right solution should be calculating the exact right
  ...
  if (num_experts >= 256) {
    APHRODITE_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_global_mem_kernel", [&] {
          ...
          auto kernel =
              aphrodite::moe::moe_align_block_size_global_mem_kernel<scalar_t>;
    ...
    APHRODITE_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_kernel", [&] {
          ...
          auto kernel = aphrodite::moe::moe_align_block_size_kernel<scalar_t>;
          AT_CUDA_CHECK(
