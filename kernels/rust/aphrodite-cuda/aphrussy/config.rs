use aphrodite::config::{ModelMeta, AphroditeConfig};
...
impl TchAphroditeConfig for AphroditeConfig<TModel> {
    fn verify_args(&self) -> Result<()> {
...
pub trait AphroditeModelConfig {
